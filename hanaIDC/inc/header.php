<?php
    include($_SERVER['DOCUMENT_ROOT']."/data/dbconnect.php");
?>
<!doctype html>
                            ...
                            <div class="menu-wrap">
                                <nav class="menu-nav">
                                    ...
                                    <div class="navbar-wrap main-menu d-none d-lg-flex">
                                        <ul class="navigation">
                                            <li><a href="index_new.php" class="section-link">Home</a> </li>
                                            <li><a href="sub.php" class="section-link">Learning Center</a></li>
                                            <li><a href="#roadmap" class="section-link">M2E</a></li>
                                            <li><a href="coinlist.php" class="section-link">My ChaT</a></li>
                                    ...
                                    <div class="header-action d-none d-md-block">
                                        <ul>
                                            <li class="header-lang"><span class="selected-lang">ENG</span>
                                     	    ...
                                     	    <li class="header-btn">	<script src="./js/main.js"></script>  </li>
                                        </ul>
                                    </div>
                                </nav>
                            </div>
